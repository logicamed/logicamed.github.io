...
aggiungiAttributo(new Attributo("h", "Equità"));
...
aggiungiAttributo(new Attributo("o", "Umanità"));
...
aggiungiAttributo(new Attributo("u", "Integrità"));
...
aggiungiAttributo(new Attributo("ae", "Felicità"));
aggiungiAttributo(new Attributo("af", "Potenzialità"));
aggiungiAttributo(new Attributo("ag", "Intelligenze"));
aggiungiAttributo(new Attributo("ah", "Cura di sè"));
...
aggiungiRicaduta(new Ricaduta("r7", "Competitività", "positiva"));
...
aggiungiRicaduta(new Ricaduta("r11", "Responsabilità", "negativa"));
...
aggiungiRicaduta(new Ricaduta("r15", "Pubblicità", "positiva"));
...
aggiungiRicaduta(new Ricaduta("r26", "Priorità", "positiva"));
...
aggiungiRicaduta(new Ricaduta("r36", "Integrità", "positiva"));
